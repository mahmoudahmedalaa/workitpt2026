...
class EmergencyInfoWidget extends StatefulWidget {
  ...
  @override
  State<EmergencyInfoWidget> createState() => _EmergencyInfoWidgetState();
}

class _EmergencyInfoWidgetState extends State<EmergencyInfoWidget> {
